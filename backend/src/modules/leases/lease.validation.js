...
const fields = {
  ...
  startDate: z.coerce.date(), endDate: z.coerce.date(), monthlyRent: z.coerce.number().positive(), securityDeposit: z.coerce.number().min(0).default(0), currency: currencyCode, securityDepositCurrency: currencyCode,
